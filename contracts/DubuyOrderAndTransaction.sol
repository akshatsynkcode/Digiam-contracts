...
contract DubuyOrderAndTransaction {
    ...
    // Struct to store booking details, including description
    ...
    // Anyone can call this function to create a booking, now with description field
    function createBooking(
        ...
        string memory _description // New parameter for description
    ) public {
